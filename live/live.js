import { BUILD_COMMIT as LIVE_BUILD_COMMIT } from './build-info.js?v=20260721-media-5';
...
async function ensurePreviewClient() {
  ...
  try {
    const { PreviewClient } = await import('./broadcast/preview_client.js?v=20260721-media-5');
